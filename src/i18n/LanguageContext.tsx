...
export const translations: Translations = {
  // Common
  appName: { vi: "Hệ thống Quản lý Thang máy", en: "Elevator Management System" },
  ...
  confirmDelete: { vi: "Xác nhận xóa sự cố này?", en: "Confirm delete this incident?" },

  // Auth
  loginTitle: { vi: "Đăng nhập", en: "Login" },
  loginDesc: { vi: "Nhập email hoặc số điện thoại để truy cập hệ thống.", en: "Enter email or phone number to access the system." },
  identifierLabel: { vi: "Email hoặc Số điện thoại", en: "Email or Phone Number" },
  passwordLabel: { vi: "Mật khẩu", en: "Password" },
  signInBtn: { vi: "Đăng nhập", en: "Sign In" },
  loginError: { vi: "Thông tin đăng nhập không hợp lệ.", en: "Invalid credentials." },
  mockAccounts: { vi: "Tài khoản mẫu (Mật khẩu: password)", en: "Mock Accounts (Password: password)" },
  ...
  updateCompletion: { vi: "Cập nhật ngày hoàn thành", en: "Update Completion Date" },
  ...
  userManagementDesc: { vi: "Quản lý tài khoản nhân viên, vai trò và quyền truy cập.", en: "Manage staff accounts, roles, and system access." },
  addUser: { vi: "Thêm người dùng", en: "Add User" },
  registeredUsers: { vi: "Người dùng đã đăng ký", en: "Registered Users" },
  accountsInSystem: { vi: "Tài khoản hiện có trong hệ thống", en: "Accounts currently in the system." },
